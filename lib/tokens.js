...
export const ROLES = [
  ...
  'border', 'input', 'ring',
  // shadcn has no equivalent. A terminal is a terminal regardless of the page
  // around it, which is a position this system takes on purpose.
  'terminal', 'terminal-foreground', 'terminal-foreground-muted',
